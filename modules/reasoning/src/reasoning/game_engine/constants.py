...
`common/configs/ludo/rules.yaml`) so `common.type`'s validation and this
...
board config (e.g. modules/common/configs/ludo/board.yaml). Every function in
...
# shared_step 1..HOME_ENTRY) — this is the same fact as "home_entry is
